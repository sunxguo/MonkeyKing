<div class="padding10 contentlist">
	<div id="appDiv" class="titA tit-bot pb5" style="">
		<div class="tabDiv">
			...
			<div  onclick="location.href='/admin/contentList?type=image'" class="center active">
				图片
			</div>
			<div  onclick="location.href='/admin/contentList?type=forum'" class="right">
				帖子
			</div>
			<div class="clear">
			</div>
	...
	<table style="width: 100%;">
		...
		<tbody>
			...
			<tr>
				<td>
					<a href="/admin/editColumn?column=<?php echo $cont->image_column;?>" target="_blank">
						<?php echo $columns[$cont->image_column]->column_name;?>
					</a>
				</td>
				<td><img src="<?php echo $cont->image_src;?>" style="width:98%;max-height:50px;"></td>
				<td>
					<a href="/admin/editContent?type=image&image=<?php echo $cont->image_id;?>"><?php echo $cont->image_title;?></a>
				</td>
				<td><?php echo $cont->image_create_time;?></td>
				<td><?php echo $cont->image_lastmodify_time;?></td>
				<td><?php echo $cont->image_visits;?></td>
				<td><?php echo $contentState[$cont->image_state];?></td>
				<td>
					<a href="/admin/editContent?type=image&image=<?php echo $cont->image_id;?>">编辑</a>
					<a href="javascript:delImage('<?php echo $cont->image_id;?>','确定删除该文章【<?php echo $cont->image_title;?>】？','成功删除图片【<?php echo $cont->image_title;?>】！正在刷新...');">删除</a>
				</td>
			</tr>
			<?php endforeach;?>
		</tbody>
