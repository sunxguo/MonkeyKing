<div class="padding10 formList clearfix">
	<div id="appDiv" class="titA tit-bot pb5" style="">
		<div class="tabDiv">
			<div onclick="location.href='/admin/addContent?type=essay'" class="left">
				文章
			</div>
			<div onclick="location.href='/admin/addContent?type=image'" class="right active">
				图片
			</div>
			<div class="clear">
			</div>
		...
		<div id="Div1">
			<div class="item itemLeft" style="margin-top: 10px;">
				...
				<span style="color: red;">*</span>
					...
					<span style="color: red;">--还没有图片集类型的栏目，请添加--</span>
					<?php endif;?>
				<br>
			</div>
	...
	<div class="btn-center">
		<a href="javascript:imageHandler(0,'发布成功！正在刷新...',true)" class="btnfa120">发布</a>
		<a href="javascript:imageHandler(1,'成功保存草稿！正在刷新...',true)" class="btn120">存草稿</a>
	</div>
</div>
